...
import { altthemeLightest, theme, themeLightest } from './Exports/Colors';
...
function BottomMenu({ iconName, isCurrent, label, value, index }) {
  return (
    <View
      style={{
        height: '100%',
    ...
    >
      ...
      />
      <Text style={{ color: isCurrent ? TAB_ACTIVE_COLOR : TAB_INACTIVE_COLOR }}>{label}</Text>
    </View>
  );
}
