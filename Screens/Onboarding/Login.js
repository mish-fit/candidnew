    ...
    <ScrollView contentContainerStyle={{}} style={{ flex: 1 }}>
      {!screen ? (
        <View style={{ flex: 1 }}>
          ...
          <View
            style={[{ justifyContent: 'center', alignItems: 'center', marginTop: height * 0.05 }]}
          >
          ...
          >
            ...
            <View
              style={{ flex: 1, borderBottomColor: '#EEE', borderBottomWidth: 1, marginLeft: 10 }}
            >
              <TextInput
                style={
                  length ? { fontSize: 25, letterSpacing: 1 } : [{ fontSize: 15, letterSpacing: 1 }]
                }
          ...
          <TouchableOpacity
            style={{
              ...
              borderRadius: 10,
              padding: 10,
              backgroundColor: loginClick || !valid ? '#888' : theme,
              justifyContent: 'center',
              alignItems: 'center',
            }}
          ...
          >
            <Text style={{ fontSize: 12 }}>
              <Ionicons name="shield-checkmark-outline" size={20} color="green" /> 100% Safe. We
            ...
            >
              <Text style={{ fontSize: 12, textAlign: 'center' }}>
                ...
                https://www.getcandid.app/privacypolicy
              </Text>
            </Hyperlink>
          </View>
          {/* <View style = {{}} /> */}
        ...
        <View style={{}}>
          ...
          <TouchableOpacity
            style={{
              ...
              borderRadius: 10,
              padding: 10,
              backgroundColor: otpClick || !otpvalid ? '#888' : theme,
              justifyContent: 'center',
              alignItems: 'center',
            }}
          ...
          <View style={{ marginTop: 10, justifyContent: 'center', alignItems: 'center' }}>
            {secs > 0 ? (
              <Text style={{}}>
                Resend OTP in {Math.floor(secs / 60)}:{secs % 60 < 10 ? `0${secs % 60}` : secs % 60}
              </Text>
            ) : (
              <TouchableOpacity
                style={{}}
