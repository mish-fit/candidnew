  ...
  return (
    <View style = {{flex : 1 , backgroundColor : theme}}>
      ...
      <View style = {{justifyContent : 'center', alignItems : 'center', flex : 1 ,}} >
        ...
        <TouchableOpacity style = {{marginTop:20, backgroundColor : theme, padding : 10 , borderRadius : 20,}} onPress = {signoutToHome}>
            <Text style = {{color : 'white', fontWeight : 'bold', fontSize : 16}}>Sign Out</Text>
        </TouchableOpacity>
        <TouchableOpacity style = {{marginTop:20, backgroundColor : 'white', padding : 10 , borderRadius : 5, }} onPress = {noToHome}>
