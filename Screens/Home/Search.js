...
function Search() {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(`${URL}/search/feedproducts`, { params: { product_text: '' } }, { timeout: 3000 })
      .then((res) => res.data)
      .then((responseData) => {
  ...
  const onClickSearchItemChild = (product_name, product_id) => {
    ...
    navigation.navigate('ProductPage', { product_name, product_id, userInfo });
  ...
  const searchProduct = (text) => {
    ...
    axios
      .get(`${URL}/search/feedproducts`, { params: { product_text: text } }, { timeout: 3000 })
      .then((res) => res.data)
      .then((responseData) => {
        console.log('SearchArray', responseData);
        setSearchLoading(false);
