...
import {Animated, View, Text,TouchableOpacity, Easing, Dimensions, Pressable, Share} from 'react-native'
import { background, colorsArray, themeLight , theme, themeLightest} from '../Exports/Colors'
    ...
    return (
        <View style = {{justifyContent : 'center',flex : 1, backgroundColor : background}}>
            <View>
                <LottieView
                progress = {progress}
                style={{width : Dimensions.get('screen').width , height : Dimensions.get('screen').width*0.5}}
