...
import { alttheme, backArrow, background, colorsArray } from '../Exports/Colors'
        ...
        !showLongComment ? <View style = {{flex : 1 ,backgroundColor : 'white'}}>
            ...
            <View style = {{marginTop : 50 , borderTopColor : "#EEE" , borderTopWidth : 2, flex : 1}}>
                <View style={add.element}>
                    {!productSelected ? <View style = {{paddingVertical: 10, marginHorizontal : 5, flexDirection : 'row', justifyContent : 'space-between', borderRadius : 10, borderWidth : 1, borderColor : '#888', paddingHorizontal : 5}}>
                    ...
                    <View style = {{paddingVertical: 5, marginHorizontal : 5, flexDirection : 'row', justifyContent : 'space-between',  paddingHorizontal : 5}}>
                        <Text style = {{color : theme, fontSize : 15 , fontWeight : 'bold'}}>{searchTextProduct}</Text>
                        <TouchableOpacity 
                            style = {{padding : 2 ,  marginRight : 10, justifyContent :'center', alignItems:'center',}}
                ...
                <View style = {{marginHorizontal : 10, marginVertical : 20, }}>
                    ...
                    {imageAdded ? <TouchableOpacity onPress = {pickImage}
                        ...
                        borderRadius : 2, marginTop : 10, height : 50, borderWidth : 1 , borderColor : '#EEE', paddingHorizontal : 10,justifyContent : 'space-between',
                        alignItems:'center'}}>
                    ...
                    <TouchableOpacity onPress = {pickImage}
                        ...
                        borderRadius : 2, padding : 5, marginTop : 10, height : 50, 
                        alignItems:'center'}}>
