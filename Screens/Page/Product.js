...
import { colorsArray, theme, themeLight, backArrow } from '../Exports/Colors';
...
function Product() {
  ...
  React.useEffect(() => {
    Amplitude.logEventAsync('PRODUCT PAGE');
    setLoading(true);
    axios
  ...
  function HeaderComponent() {
    return (
      ...
      >
        <TouchableOpacity onPress={() => navigation.navigate('Home')} style={add.headerBack}>
