      ...
      >
        ...
        <TouchableOpacity
          ...
          style={{
            ...
            justifyContent: 'space-between',
            paddingRight: 10,
            backgroundColor: !filterCategoryModalVisible ? 'white' : 'black',
          }}
        >
          <Text
            style={{
              fontWeight: 'bold',
              marginRight: 10,
              color: filterCategoryModalVisible ? 'white' : 'black',
            }}
          >
            Categories
          </Text>
  ...
  const filterContextFunc = () => {
    axios
      .get(
        ...
        { params: { category_id: JSON.stringify(categoriesRequest), page: 0 } },
        { timeout: 5000 }
      )
      .then((res) => res.data)
      .then((responseData) => {
    ...
    if (contextsRequest.length) {
      axios
        .get(
          ...
          {
            params: {
              category_id: JSON.stringify(categoriesRequest),
              context_id: JSON.stringify(contextsRequest),
            },
          },
          { timeout: 5000 }
        )
